/** ISO 3166-1 alpha-2 country list for admin targeting (events + campaigns). */
...
/** Shown first in pickers — Southern Africa + common ad markets. */
...
export function formatCountryLabel(code: string | null | undefined): string {
  ...
  return c ? `${c.name} (${c.code})` : code?.trim().toUpperCase() || "";
}
...
export function popularCountries(): CountryOption[] {
